...
const EZINVEST_LOGO = 'https://consumersiteimages.trustpilot.net/business-units/5ba3ba86026be000014dccd9-198x149-1x.jpg'
...
export default function MerchantLogo({ merchant }: { merchant: string | null | undefined }) {
  ...
  const logo = uploadedLogo ?? (isMelBet ? MELBET_LOGO : isEzInvest ? EZINVEST_LOGO : null)
