...
export interface DepositRow {
  ...
  sms?: { id: number; sender_name: string | null; sender_number?: string | null; receiver_number?: string | null; wallet_number?: string | null; confirmed_wallet_number?: string | null; amount: number | null; balance_after: number | null; received_at: string | null; raw_sms?: string | null; message?: string | null; sms_first_line?: string | null } | null
